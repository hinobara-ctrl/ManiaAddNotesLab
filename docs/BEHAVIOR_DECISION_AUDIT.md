...
El inventario contiene **100 decisiones**: 3 `USER_INTENT`, 6 `HARD_VALIDITY_INVARIANT`, 9 `CURRENT_POLICY_CONTRACT`, 1 `FUTURE_POLICY_CONTRACT`, 49 `MAPPER_DERIVED_CANDIDATE`, 21 `IMPLEMENTATION_ONLY` y 11 `OPEN_DESIGN_DECISION`. D1 sigue sin estar activo en el producto: fue un treatment A/B explícito que cerró Outcome C, sin promoción, y quedó PARKED. C1.2 representa la señal exact-head; D0–D0.2 completion/context; F1 evidence state; F2 gaps/backoff; F2.1 information loss; F2.2 compatibility condicional; F2.3 domain/truth/acquisition boundaries; E recurrence/boundaries inferidas; E.1 failure diagnostics. D1.0 cerró Outcome A representacional y D1.GATE preserva la preregistración verificable. No queda una fase accionable. Ninguna policy mapper-derived gobierna el selector normal; el default continúa legacy.
