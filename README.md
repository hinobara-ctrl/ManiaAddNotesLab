...
- **SAFETY.REMEDIATION.GATE — COMPLETE, REMEDIATION_RUNTIME_CERTIFIED, EXPERIMENTAL ONLY:** el treatment canónico eliminó 215/215 condiciones hard del control en 224 pares, sin RNG, deriva G1, fallos de reparse ni violaciones nuevas. Default y promoción siguen intactos.

La generación default continúa en `legacy-experimental.1`; el perfil sigue en `phase-a.1` y diagnostics en `phase-c1-2-shadow.1`. G1.GATE y SAFETY.REMEDIATION.GATE existen sólo como treatments research explícitos y no están expuestos en CLI/Web. La certificación de la remediación no promueve G1; G1 de utilidad, G2/H y cualquier sucesora siguen sin autorización.
